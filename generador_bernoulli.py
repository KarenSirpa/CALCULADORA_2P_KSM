...
class GeneradorBernoulliApp:
    def __init__(self, root):
        ...
        # Treeview (tabla)
        style.configure("Treeview", background=blanco, foreground=negro, fieldbackground=blanco)
    ...
    def create_widgets(self):
        ...
        prueba_frame = tk.Frame(self.root, bg="#FFFFFF")
        prueba_frame.pack(pady=10)
        ttk.Button(prueba_frame, text="Prueba de Medias", command=self.prueba_medias).pack(side=tk.LEFT, padx=5)
        ttk.Button(prueba_frame, text="Prueba de Varianza", command=self.prueba_varianza).pack(side=tk.LEFT, padx=5)
        ttk.Button(prueba_frame, text="Prueba de Uniformidad", command=self.prueba_uniformidad).pack(side=tk.LEFT, padx=5)

    # --- Resto del código sin cambios en lógica ---
    # Solo se ajustan los colores en las ventanas emergentes
    ...
    def generar_numeros(self):
        try:
            ...
            for i, val in enumerate(valores):
                self.tree.insert("", tk.END, values=(i + 1, val))
    ...
    def prueba_medias(self):
        ...
        ventana_prueba.configure(bg="#FFFFFF")

        style = ttk.Style()
        style.theme_use('clam')
        style.configure("TButton", background="#F8BBD0", foreground="#000000", font=("Arial", 10, "bold"))
        style.map("TButton", background=[('active', "#F48FB1")], foreground=[('active', "#000000")])
        ...
        tk.Label(ventana_prueba, text="Valor de Z_alpha/2:", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        btn_frame = tk.Frame(ventana_prueba, bg="#FFFFFF")
        btn_frame.pack(pady=10)
        ttk.Button(btn_frame, text="Ejecutar", command=ejecutar_prueba).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Histograma", command=lambda: self.mostrar_histograma(r_values)).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Exportar", command=lambda: self.exportar_medias(r_values, z_var.get())).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Volver", command=ventana_prueba.destroy).pack(side=tk.LEFT, padx=5)
    ...
    def prueba_varianza(self):
        ...
        tk.Label(ventana_prueba, text="Prueba de Varianza", font=("Arial", 16, "bold"), bg="#FFFFFF", fg="#000000").pack(pady=10)
        ...
        tk.Label(ventana_prueba, text="Modo de cálculo:", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        tk.Radiobutton(ventana_prueba, text="Automático", variable=modo_var, value="automático", bg="#FFFFFF", fg="#000000", selectcolor="#F8BBD0", command=toggle_campos).pack(anchor="w", padx=20)
        tk.Radiobutton(ventana_prueba, text="Manual", variable=modo_var, value="manual", bg="#FFFFFF", fg="#000000", selectcolor="#F8BBD0", command=toggle_campos).pack(anchor="w", padx=20)

        tk.Label(ventana_prueba, text="Nivel de Confianza (ej. 0.95):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana_prueba, text="χ²(α/2, n-1):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana_prueba, text="χ²(1-α/2, n-1):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        ttk.Button(btn_frame, text="Ejecutar", command=ejecutar_prueba).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Histograma", command=lambda: self.mostrar_histograma(r_values)).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Exportar", command=lambda: self.exportar_varianza(r_values, modo_var.get(), confianza_var.get(), chi_alpha_2_var.get(), chi_1_minus_alpha_2_var.get())).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Volver", command=ventana_prueba.destroy).pack(side=tk.LEFT, padx=5)
    ...
    def prueba_uniformidad(self):
        ...
        tk.Label(ventana_prueba, text="Prueba de Uniformidad", font=("Arial", 16, "bold"), bg="#FFFFFF", fg="#000000").pack(pady=10)

        m_var = tk.IntVar(value=10)
        confianza_var = tk.DoubleVar(value=0.95)

        tk.Label(ventana_prueba, text="Número de intervalos (m):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        ttk.Button(btn_frame, text="Ejecutar", command=ejecutar_prueba).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Histograma", command=lambda: self.mostrar_histograma(r_values)).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Exportar", command=lambda: self.exportar_uniformidad(r_values, m_var.get(), confianza_var.get())).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Volver", command=ventana_prueba.destroy).pack(side=tk.LEFT, padx=5)
    ...
    def mostrar_histograma(self, r_values):
        ...
        ax.hist(r_values, bins=10, alpha=0.7, color='#F8BBD0', edgecolor='#F48FB1', linewidth=1.5)
