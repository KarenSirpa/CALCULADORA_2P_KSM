...
class CuadradosMediosApp:
    ...
    def prueba_medias(self):
        ...
        style = ttk.Style()
        style.theme_use('clam')
        style.configure("TButton", background="#FF98E9", foreground="white", font=("Arial", 10))
        style.map("TButton", background=[('active', "#C24EA9")])
    ...
    def prueba_varianza(self):
        ...
        style = ttk.Style()
        style.theme_use('clam')
        style.configure("TButton", background="#FC7DF5", foreground="white", font=("Arial", 10))
        style.map("TButton", background=[('active', "#FD61E3")])
    ...
    def prueba_uniformidad(self):
        ...
        style = ttk.Style()
        style.theme_use('clam')
        style.configure("TButton", background="#FF96F1", foreground="white", font=("Arial", 10))
        style.map("TButton", background=[('active', "#FA4FE3")])
