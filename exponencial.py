...
class ExponencialApp:
    def __init__(self, root):
        ...
        style.configure("Treeview.Heading", background="#FF33E4", foreground="white", font=("Arial", 10, "bold"))
        style.map("Treeview.Heading", background=[('active', "#FD3AF3")])
        style.configure("TButton", background="#FA43EB", foreground="white", font=("Arial", 10))
        style.map("TButton", background=[('active', "#FF46F6")])
    ...
    def create_widgets(self):
        ...
        # Campo para media
        tk.Label(input_frame, text="media:", font=("Arial", 11), bg="#E3F2FD", fg="#FF50FF").grid(row=0, column=0, sticky="w", padx=10, pady=5)
    ...
    def prueba_medias(self):
        ...
        style = ttk.Style()
        style.theme_use('clam')
        style.configure("TButton", background="#FF9CFA", foreground="white", font=("Arial", 10))
        style.map("TButton", background=[('active', "#FA4DE3")])

        tk.Label(ventana, text="Prueba de Medias", font=("Arial", 16, "bold"), bg="#E3F2FD", fg="#F538FC").pack(pady=10)

        z_var = tk.DoubleVar(value=1.96)
        tk.Label(ventana, text="Valor de Z_alpha/2:", font=("Arial", 11), bg="#E3F2FD", fg="#F74AEE").pack(anchor="w", padx=20)
    ...
    def prueba_varianza(self):
        ...
        tk.Label(ventana, text="Prueba de Varianza", font=("Arial", 16, "bold"), bg="#E3F2FD", fg="#FC2DF1").pack(pady=10)
        tk.Label(ventana, text="Modo de cálculo:", font=("Arial", 11), bg="#E3F2FD", fg="#F736D6").pack(anchor="w", padx=20)
        tk.Radiobutton(ventana, text="Automático", variable=modo_var, value="automático", bg="#E3F2FD", fg="#FA37EA", selectcolor="#FD53EF", command=toggle_campos).pack(anchor="w", padx=20)
        tk.Radiobutton(ventana, text="Manual", variable=modo_var, value="manual", bg="#E3F2FD", fg="#FF3EE5", selectcolor="#FF40EF", command=toggle_campos).pack(anchor="w", padx=20)

        tk.Label(ventana, text="Nivel de Confianza (ej. 0.95):", font=("Arial", 11), bg="#E3F2FD", fg="#FD3DED").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana, text="χ²(α/2, n-1):", font=("Arial", 11), bg="#E3F2FD", fg="#FF41FF").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana, text="χ²(1-α/2, n-1):", font=("Arial", 11), bg="#E3F2FD", fg="#FF51F6").pack(anchor="w", padx=20)
    ...
    def prueba_uniformidad(self):
        ...
        tk.Label(ventana, text="Prueba de Uniformidad", font=("Arial", 16, "bold"), bg="#E3F2FD", fg="#FD2FFD").pack(pady=10)
        tk.Label(ventana, text="Número de intervalos (m):", font=("Arial", 11), bg="#E3F2FD", fg="#FC1BF0").pack(anchor="w", padx=20)
        m_entry = tk.Entry(ventana, textvariable=m_var, width=10, font=("Arial", 10), relief="solid", bd=2)
        m_entry.pack(pady=5, padx=20)

        tk.Label(ventana, text="Nivel de Confianza (ej. 0.95):", font=("Arial", 11), bg="#E3F2FD", fg="#F542E6").pack(anchor="w", padx=20)
        confianza_entry = tk.Entry(ventana, textvariable=confianza_var, width=10, font=("Arial", 10), relief="solid", bd=2)
        confianza_entry.pack(pady=5, padx=20)
