...
class GeneradorUniformeApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(input_frame, text="a (Límite inferior):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").grid(row=0, column=0, sticky="w", padx=10, pady=5)
        tk.Entry(input_frame, textvariable=self.a_var, width=20, font=("Arial", 10), relief="solid", bd=2).grid(row=0, column=1, padx=10, pady=5)

        tk.Label(input_frame, text="b (Límite superior):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").grid(row=1, column=0, sticky="w", padx=10, pady=5)
