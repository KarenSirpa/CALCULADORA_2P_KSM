...
class PruebaKerlandApp:
    ...
    def create_widgets(self):
        ...
        # Campo para k
        tk.Label(input_frame, text="k:", font=("Arial", 11), bg="white", fg="black").grid(row=0, column=0, sticky="w", padx=10, pady=5)
        tk.Entry(input_frame, textvariable=self.k_var, width=10, font=("Arial", 10), relief="solid", bd=2).grid(row=0, column=1, padx=10, pady=5)

        # Campo para media
        tk.Label(input_frame, text="media:", font=("Arial", 11), bg="white", fg="black").grid(row=1, column=0, sticky="w", padx=10, pady=5)
    ...
    def prueba_medias(self):
        ...
        tk.Label(ventana, text="Prueba de Medias", font=("Arial", 16, "bold"), bg="white", fg="black").pack(pady=10)

        z_var = tk.DoubleVar(value=1.96)
        tk.Label(ventana, text="Valor de Z_alpha/2:", font=("Arial", 11), bg="white", fg="black").pack(anchor="w", padx=20)
    ...
    def prueba_varianza(self):
        ...
        tk.Label(ventana, text="Prueba de Varianza", font=("Arial", 16, "bold"), bg="white", fg="black").pack(pady=10)
        tk.Label(ventana, text="Modo de cálculo:", font=("Arial", 11), bg="white", fg="black").pack(anchor="w", padx=20)
        tk.Radiobutton(ventana, text="Automático", variable=modo_var, value="automático", bg="white", fg="black", selectcolor=rosa, command=toggle_campos).pack(anchor="w", padx=20)
        tk.Radiobutton(ventana, text="Manual", variable=modo_var, value="manual", bg="white", fg="black", selectcolor=rosa, command=toggle_campos).pack(anchor="w", padx=20)

        tk.Label(ventana, text="Nivel de Confianza (ej. 0.95):", font=("Arial", 11), bg="white", fg="black").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana, text="χ²(α/2, n-1):", font=("Arial", 11), bg="white", fg="black").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana, text="χ²(1-α/2, n-1):", font=("Arial", 11), bg="white", fg="black").pack(anchor="w", padx=20)
    ...
    def prueba_uniformidad(self):
        ...
        tk.Label(ventana, text="Prueba de Uniformidad", font=("Arial", 16, "bold"), bg="white", fg="black").pack(pady=10)
        tk.Label(ventana, text="Número de intervalos (m):", font=("Arial", 11), bg="white", fg="black").pack(anchor="w", padx=20)
    ...
    def mostrar_histograma(self, r_values):
        ...
        ax.hist(r_values, bins=5, alpha=0.7, color='#F8BBD0', edgecolor='black', linewidth=1.5)  # Rosa suave
        kde = gaussian_kde(r_values)
        x = np.linspace(0, 1, 100)
        ax.plot(x, kde(x), color='black', linewidth=2, label='Densidad Observada (KDE)')
        ax.axhline(y=len(r_values)/10, color='black', linestyle='--', linewidth=2, label='Frecuencia Esperada')
