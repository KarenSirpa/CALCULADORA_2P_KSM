...
class GammaApp:
    def __init__(self, root):
        ...
        style.configure("Treeview.Heading", background="#FFC0CB", foreground="black", font=("Arial", 10, "bold"))
        style.map("Treeview.Heading", background=[('active', "#FFB6C1")])
        style.configure("TButton", background="#FFC0CB", foreground="black", font=("Arial", 10))
    ...
    def create_widgets(self):
        ...
        tk.Label(input_frame, text="Media (μ):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").grid(row=0, column=0, sticky="w", padx=10, pady=5)
        ...
        tk.Label(input_frame, text="Varianza (σ²):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").grid(row=1, column=0, sticky="w", padx=10, pady=5)
        ...
        tk.Label(input_frame, text="Número de valores (n):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").grid(row=2, column=0, sticky="w", padx=10, pady=5)
    ...
    # El resto del código (métodos generar_numeros, limpiar_tabla, get_r_values, pruebas, etc.)
    # permanece exactamente igual, ya que no afectan los colores de la interfaz principal.
    # Solo los cuadros emergentes (Toplevel) también deben actualizarse:
    ...
    def prueba_medias(self):
        ...
        tk.Label(ventana, text="Prueba de Medias", font=("Arial", 16, "bold"), bg="#FFFFFF", fg="#000000").pack(pady=10)

        z_var = tk.DoubleVar(value=1.96)
        tk.Label(ventana, text="Valor de Z_alpha/2:", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        btn_frame = tk.Frame(ventana, bg="#FFFFFF")
    ...
    def prueba_varianza(self):
        ...
        tk.Label(ventana, text="Prueba de Varianza", font=("Arial", 16, "bold"), bg="#FFFFFF", fg="#000000").pack(pady=10)
        ...
        tk.Label(ventana, text="Modo de cálculo:", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        tk.Radiobutton(ventana, text="Automático", variable=modo_var, value="automático", bg="#FFFFFF", fg="#000000", selectcolor="#FFB6C1", command=toggle_campos).pack(anchor="w", padx=20)
        tk.Radiobutton(ventana, text="Manual", variable=modo_var, value="manual", bg="#FFFFFF", fg="#000000", selectcolor="#FFB6C1", command=toggle_campos).pack(anchor="w", padx=20)

        tk.Label(ventana, text="Nivel de Confianza (ej. 0.95):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana, text="χ²(α/2, n-1):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
        ...
        tk.Label(ventana, text="χ²(1-α/2, n-1):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
    ...
    def prueba_uniformidad(self):
        ...
        tk.Label(ventana, text="Prueba de Uniformidad", font=("Arial", 16, "bold"), bg="#FFFFFF", fg="#000000").pack(pady=10)

        m_var = tk.IntVar(value=10)
        confianza_var = tk.DoubleVar(value=0.95)

        tk.Label(ventana, text="Número de intervalos (m):", font=("Arial", 11), bg="#FFFFFF", fg="#000000").pack(anchor="w", padx=20)
    ...
    def mostrar_histograma(self, r_values):
        ...
        ax.hist(r_values, bins=10, alpha=0.7, color='#FFC0CB', edgecolor='black', linewidth=1.5)
    ...
    # Métodos de exportación (sin cambios visuales, solo funcionales)
    ...
    def get_r_values(self):
        if not hasattr(self, 'valores_gamma') or len(self.valores_gamma) == 0:
            return np.array([])
